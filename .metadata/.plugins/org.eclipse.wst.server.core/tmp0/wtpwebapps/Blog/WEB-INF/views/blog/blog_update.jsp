...
$(document).ready(function(){
	...
	$("#saveBtn").on("click", function(){
		...
		if($.trim($("#title").val())== ""){
			...
			var params = $("#updateForm2").serialize();
...
<div class="main_content">
	...
	<div class="content_center">
		...
		<form action="#" id="updateForm2" method="post" style="text-align:center;">
		<input type="hidden" name="qwe" id="qwe" value="${param.qwe}"/>
		<div style="display:inline-block; ">
			...
			<table cellspacing="0">
				<tbody>
					<tr>
						<th>제목</th>
						<td><input type="text" name="title" id="title" class="title" value="${data.P_TITLE}"/> </td>
					</tr>
					<tr>
						<th>작성자</th>
					...
					<tr>
						<th>내용</th>
						<td><textarea name="con" id="con" rows="10" cols="20">${data.P_CON} </textarea> </td>
					</tr>
				</tbody>
			</table>
		
		</div>
		<input style="font-family: 'Cute Font', cursive;" type="button" id="saveBtn" class="saveBtn"  value="수정"/>
